(() => {
  ...
  const DEFAULT_FEATURED_OVERLAY_MASK_URL = "/public/assets/featured/overlay-voxlis.png";
  const DEFAULT_BANNER_OVERLAY_MASK_URL = "/public/assets/banner/voxlis-banner.png";
  const DEFAULT_HEADER_OVERLAY_MASK_URL = "/public/assets/header/voxlis-banner.png";
  const DEFAULT_SPONSOR_OVERLAY_MASK_URL = "/public/assets/logo/keyempire-logo.png";
