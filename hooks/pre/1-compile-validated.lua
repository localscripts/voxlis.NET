...
local COPYRIGHT = [[
THIS FILE CONTAINS PROPRIETARY VOXLIS DATA.

ALL DATA WITHIN THIS FILE - INCLUDING BUT NOT LIMITED TO PRODUCT DATA, REVIEWS, POINTS, PRICING, CONTENT, METADATA, SCHEMAS, AND DERIVED STRUCTURES - IS CONFIDENTIAL AND PROTECTED INTELLECTUAL PROPERTY.

UNAUTHORISED COPYING, EXTRACTION, REUSE, REDISTRIBUTION, SCRAPING, OR DERIVATIVE USE OF THIS DATA IS STRICTLY PROHIBITED.

THIS DATA IS PROVIDED SOLELY FOR USE BY THE VOXLIS WEBSITE AND ITS ASSOCIATED SYSTEMS.
NO RIGHTS ARE GRANTED FOR USE OUTSIDE OF VOXLIS WITHOUT EXPLICIT PRIOR WRITTEN PERMISSION.

LEGAL OWNERSHIP OF ALL DATA RESIDES WITH VOXLIS.
ENGINEERING SYSTEMS HANDLING THIS DATA ARE AUTHORED BY NUMELON LTD.

SEE THE VOXLIS WEBSITE REPOSITORY ROOT LICENSE FILE FOR GOVERNING TERMS AND APPLICABLE LAW:
https://github.com/localscripts/voxlis.NET/blob/main/LICENSE
]]
