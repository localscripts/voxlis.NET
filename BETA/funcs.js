const Data = [
{
  "zenith": {
    "main": {
      "name": "Zenith",
      "plat": ["windows"],
      "desc": "Widely used paid execution solution",
    ...
    "links": {
      ...
      "priceHref": "https://www.key-empire.com/#zenith",
      "unclinks": {
        "windows": "https://sunc.rubis.app/?scrap=5zqrO9zJvAj7tE9S&key=nqZfYyWSLt37gqeNNgT4XZy1EHovYSTm"
      }
    },
    "misc": {
      "editor": "voxlis.NET",
...

  {
    ...
    "potassium": {
      ...
      "links": {
        ...
        "unclinks": {
         "windows": "https://sunc.rubis.app/?scrap=p1oItowSFMvNrpuf&key=hzn8j0diRfPUuqfNpMUetdC8kWheuziL"
        }
      },
      "misc": {
        "editor": "voxlis.NET",
    ...
    "volcano": {
      "main": {
        ...
        "pros": ["Has a decompiler", "93% sUNC", "Level 8"],
        "neutral": [],
        "cons": []
      },
      "links": {
        ...
        "unclinks": {
         "windows": "https://sunc.rubis.app/?scrap=LQ8uphMkPlKrqKgY&key=wE4Rjq07vQ4dfsHh6a0dxX4A47q1ijaE"
        }
      },
      "misc": {
        "editor": "voxlis.NET",
...
const BadgeData = [
  ...
  },
  {
    ...
    hoverInfo: "These products are the top three best-selling items on voxlis.NET",
    tooltipBg: "#6A500F"
  }
];
      ...
      document.querySelectorAll(".unc-btn").forEach((button) => {
        if (!button._hasClickHandler) {
          ...
          button.onclick = (e) => {
            ...
            if (exploit) {
              // <CHANGE> Check if exploit has unclinks structure
              if (exploit.unclinks && typeof exploit.unclinks === 'object') {
                ...
                if (platforms.length === 1) {
                  ...
                  if (!link) {
                    // <CHANGE> No link provided for single platform - open old UNC modal
                ...
                ModalManager.openUncPlatformChoiceModal(exploit)
                return
              }
...
static openUncChoiceModal(exploit, singlePlatform = null) {
  ...
  const choiceButtonsDiv = modalContainer.querySelector(".platform-choice-buttons")
...
static openSuncForPlatform(exploit, platform) {
  if (exploit.unclinks && exploit.unclinks[platform]) {
    ...
    ModalManager.showErrorNotification(`Oops! we dont have the sUNC link for this ${exploit.name} ${platform} help us get it!`)
  } else {
    ModalManager.showErrorNotification(`Oops! we dont have the sUNC link for this ${exploit.name} ${platform} help us get it!`)
  }
}
