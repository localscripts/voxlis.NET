...
A complete rewrite of Seliware has been underway since December and will launch as a separate product under a new name. All users with an active Seliware subscription at the time of the new release will receive a full transfer. Support for other platforms like macOS and iOS is also planned for future expansion.
...
- Some issues with vulnerabilities from public scripts
