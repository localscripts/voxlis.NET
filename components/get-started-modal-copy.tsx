      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Choose Your Game</h2>
        ...
        >
          {allGames.map((game, index) => (
            <div
              ...
              onClick={() => {
                window.location.href = game.redirectUrl
              }}
            >
              {/* Main Content */}
              <div className="flex items-center gap-4 flex-1">
                ...
                <div className="text-right">
                  <div className="font-bold text-lg transition-colors text-gray-900 dark:text-gray-100 group-hover:text-green-600 dark:group-hover:text-green-400">
                    From {game.price}
                  </div>
                </div>
              </div>
        ...
        >
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 justify-center">
            ...
            <span>Secure payments & instant access</span>
          </div>
        </div>
