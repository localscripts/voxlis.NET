          ...
          {quickLinks.map((link, index) => (
            ...
            >
              ...
              <div className="absolute inset-0 pointer-events-none overflow-hidden">
                {/* Floating Circles */}
                <div className="absolute top-4 right-6 w-8 h-8 bg-blue-200/20 dark:bg-blue-400/20 rounded-full animate-float-slow"></div>
                <div className="absolute bottom-6 left-4 w-6 h-6 bg-green-200/20 dark:bg-green-400/20 rounded-full animate-float-medium"></div>
                <div className="absolute top-1/2 right-2 w-4 h-4 bg-purple-200/20 dark:bg-purple-400/20 rounded-full animate-float-fast"></div>
                <div className="absolute bottom-2 right-1/3 w-10 h-10 bg-emerald-200/15 dark:bg-emerald-400/20 rounded-full animate-float-slow"></div>

                {/* Pulsing Dots */}
                <div className="absolute top-6 left-1/3 w-2 h-2 bg-blue-400/30 dark:bg-blue-300/40 rounded-full animate-pulse-slow"></div>
                <div className="absolute bottom-4 right-6 w-3 h-3 bg-green-400/25 dark:bg-green-300/40 rounded-full animate-pulse-medium"></div>

                {/* Rotating Ring */}
                <div className="absolute top-2 left-2 w-12 h-12 border border-gray-300/20 dark:border-gray-500/30 rounded-full animate-spin-slow"></div>
              </div>
